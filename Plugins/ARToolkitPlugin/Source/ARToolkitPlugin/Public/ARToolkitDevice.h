...
//NFT
#define PAGES_MAX              50          // Maximum number of NFT pages expected. 
...
bool GetRelativeTransformation(uint8 MarkerID1, uint8 MarkerID2, FVector& RelativePosition, FRotator& RelativeRotation);
	...
	bool LoadMarkers(TArray<FString> markerNames, FMarkerLoadedDelegate OnMarkerLoaded);
	bool LoadMarkersNFT(TArray<FString> markerNames, FMarkerLoadedDelegate OnMarkerLoaded, FNFTCompleteDelegate OnNFTReady);
